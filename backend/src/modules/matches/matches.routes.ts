...
import { createMatchController, lastResultsController, listMatchesController, matchStatsController, setResultController, updateMatchController } from './matches.controller.js';
