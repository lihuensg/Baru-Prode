...
export function BackendLoader() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity">
      <div className="w-full max-w-md mx-4 bg-white/10 border border-white/10 rounded-xl p-6 text-center glass-card">
        <div className="flex flex-col items-center gap-4">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-emerald-400 via-emerald-600 to-rose-500 flex items-center justify-center shadow-lg">
          ...
          <p className="text-sm text-slate-200">{message ?? 'Estamos cargando la información del torneo. Esto puede tardar unos segundos.'}</p>

          <div className="mt-3">
            <div className="animate-pulse h-2 w-48 bg-gradient-to-r from-white/30 via-white/10 to-white/30 rounded-full" />
          </div>
        </div>
      </div>
    </div>
